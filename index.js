...
const MOCK_DATABASE = [
  ...
  { id: 103, type: 'single', grade: 1, semester: 1, exam: 2, subject: '地理', question: '阿豪想在新竹置產，條件：(a)5公里內無斷層 (b)1000公尺內有量販店 (c)30分鐘車程到火車站 (d)房價低於30萬。仲介應利用哪些 GIS 分析方法？', options: ['甲丙 (坡度+內視域)', '甲丁 (坡度+疊圖)', '乙丙 (環域+內視域)', '乙丁 (環域+疊圖)', '丙丁'], correctIndices: [3], explanation: '處理「距離」條件(5公里、1000公尺) → (乙)環域分析。將所有條件疊加找出交集 → (丁)疊圖分析。' },
  ...
  const SelectionScreen = () => (
    <div className="max-w-4xl mx-auto p-6 animate-fade-in">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500">段考題庫 (化學/地理/地科/生物/物理/數學)</p>
      </div>
